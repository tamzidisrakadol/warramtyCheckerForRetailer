...
import com.example.warrantycheckerforretailer.databinding.ActivityReportListBinding;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constraints.GET_MSG, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals("0")){
                    ...
                    Toast.makeText(ReportListActivity.this, "Empty List !", Toast.LENGTH_SHORT).show();
                }
            }
